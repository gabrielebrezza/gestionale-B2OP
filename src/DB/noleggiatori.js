...
customerSchema.methods.isPasswordResetExpired = function() {
    const passwordResetTokenExpirationTime = 6 * 60 * 1000;
    const currentTime = Date.now();
    return (currentTime - this.resetPassword.createdAt.getTime()) > passwordResetTokenExpirationTime;
};
